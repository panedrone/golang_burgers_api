...
export function postJson201(uri, jsonObj, onSuccess) {
...
export function postJsonWithJsonResp(uri, jsonObj, onJson) {
    let jsonStr = JSON.stringify(jsonObj)
    fetch(uri, {
        method: 'post',
        headers: JSON_HEADERS,
...
export function putJson200(uri, jsonObj, onSuccess) {
    let jsonStr = JSON.stringify(jsonObj)
    fetch(uri, {
        method: 'put',
        headers: JSON_HEADERS,
...
export function putJson(uri, jsonObj, onResp) {
    let jsonStr = JSON.stringify(jsonObj)
    fetch(uri, {
        method: 'put',
        headers: JSON_HEADERS,
...
export async function showStatusError(resp) {
